...
class Parser:
    ...
    def declaracao_de_variaveis(self):
        ...
        while self.current_token.token == 'IDENTIFIER': #semantico
            ...
            try:
                self.symbols_table.insert(var_name, {'tipo': tipo_variavel})
    ...
    def declaracao_de_procedimento(self):
        ...
        try:
            self.symbols_table.insert(identifier, {'tipo': 'HEADER_PROC', 'parametros': parametros})
        except Exception as e:
            print(e)
    ...
    def declaracao_de_funcao(self):
        ...
        try:
            self.symbols_table.insert(identifier, {'tipo': 'HEADER_FUNC', 'retorno': tipo, 'parametros': parametros})
        except Exception as e:
            print(e)
    ...
    def chamada_de_procedimento(self):
        ...
        try:
            ...
            print(proc_info['tipo'])
            if proc_info['tipo'] != 'HEADER_PROC':
    ...
    def inferir_tipo(self, operando_esq, operando_dir, operador):
        ...
        if (tipo_esq == 'INT' and (tipo_dir == 'INT' or tipo_dir == 'NUMERIC')) or tipo_esq == 'NUMERIC' and tipo_dir == 'NUMERIC': #??????????
    ...
    def fator(self):
        ...
        if self.current_token.token == 'IDENTIFIER':
            ...
            if self.current_token.token == 'OPEN_PARENTHESES':
                ...
                if simbolo['tipo'] == 'HEADER_FUNC':
                    return {
                        'tipo': 'HEADER_FUNC',
                        'identificador': identifier,
                        'argumentos': argumentos
                    }
                elif simbolo['tipo'] == 'HEADER_PROC':
